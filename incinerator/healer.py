...
class Battle():
  ...
  def fight(self, first_army, second_army):
    ...
    while len(first_army.kind_of_unit) > 0 and len(second_army.kind_of_unit):

      if fight(first_army.kind_of_unit[0], second_army.kind_of_unit[0],first_army.kind_of_unit,second_army.kind_of_unit):
        second_army.kind_of_unit.remove(second_army.kind_of_unit[0])
        #num_unit2 -= 1
        #print(f" number of unit 2 {num_unit2 }")
      else:
        first_army.kind_of_unit.remove(first_army.kind_of_unit[0])
       # num_unit1 -= 1
